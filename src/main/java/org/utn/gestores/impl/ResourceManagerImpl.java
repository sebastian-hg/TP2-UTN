...
import org.utn.exception.BusinessException;
...
public class ResourceManagerImpl implements Classifiable.ResourceManager, Classifiable, FilterResource {
    ...
    public void createResource(GeneralAcademicResources generalAcademicResourcesList) {
        try {
            ...
            throw new BusinessException("Ocurrio un Error al momento de crear el recurso" + e.getMessage());
        }
    }
    ...
    public void generateReport(GeneralAcademicResources generalAcademicResources) {
        ...
        try {
            ...
            throw new BusinessException("Ocurrio un Erro al momento de generar el reporte" + e.getMessage());
        }
    ...
    public void filter(GeneralAcademicResources generalAcademicResourcesList) {
        ...
        try {
            ...
            switch (opcion) {
                ...
                default:
                    throw new InvalidCategoryException("Usted a elegido una categoria invalida para el filtro");
            }
    ...
    private void getReportByBooks(GeneralAcademicResources generalAcademicResources) {
        ...
        try {
            objectMapper.writeValue(new File("Books.json"), generalAcademicResources.getBookList());
    ...
    private void getReportByArticles(GeneralAcademicResources generalAcademicResources) {
        ...
        objectMapper.registerModule(new JavaTimeModule());
        try {
            objectMapper.writeValue(new File("Article.json"), generalAcademicResources.getArticleList());
    ...
    private void getReportByGeneralAcademicResource(GeneralAcademicResources generalAcademicResources) {
        ...
        objectMapper.registerModule(new JavaTimeModule());
        try {
            objectMapper.writeValue(new File("Resources.json"), generalAcademicResources);
